...
here::i_am("MouseBiogeography-RProj/Hum-Maaslin2-SITE-Genus-Hum.R")
...
input_data <- readr::read_delim(here("Humanized-Biogeography-Analysis/Site_Subsets/export_L6_Mucosal_min10000_Humanized_Colonized-ComBat-Adjusted-ASV/feature-table.tsv"), delim="\t") # choose filtered non rarefied csv file
...
fit_data = Maaslin2(input_data=df_input_data, 
                    ...
                    output = "Humanized-Biogeography-Analysis/differential_genera_site/HUM_L6-DCvsAll-CLR-Lum-ComBat-SeqRunSexSite-1-MsID", 
...
fit_data = Maaslin2(input_data=df_input_data, 
                    input_metadata=df_input_metadata, 
                    output = "Humanized-Biogeography-Analysis/differential_genera_site/HUM_L6-CLR-Lum-ComBat-SeqRunSexSite_General-1-MsID", 
...
fit_data = Maaslin2(input_data=df_input_data, 
                    input_metadata=df_input_metadata, 
                    output = "Humanized-Biogeography-Analysis/differential_genera_site/HUM_L6-DCvsAll-CLR-Muc-ComBat-SeqRunSexSite-1-MsID", 
                    fixed_effects = c("Sequencing_Run","Sex", "Site"), 
                    random_effects = c("MouseID"),normalization="clr", transform ="none",plot_heatmap = FALSE,plot_scatter = FALSE,
                    min_prevalence=0.15,
                    reference=c('Site,Distal_Colon'))
...
fit_data = Maaslin2(input_data=df_input_data, 
                    input_metadata=df_input_metadata, 
                    output = "Humanized-Biogeography-Analysis/differential_genera_site/HUM_L6-CLR-Muc-ComBat-SeqRunSexSite_General-1-MsID", 
                    fixed_effects = c("Sequencing_Run","Sex", "Site_General"), 
                    random_effects = c("MouseID"),normalization="clr", transform ="none",plot_heatmap = FALSE,plot_scatter = FALSE,
                    min_prevalence=0.15,
                    reference=c('Site_General,Colon'))
...
luminal<-readr::read_delim(here("Humanized-Biogeography-Analysis/differential_genera_site/HUM_L6-DCvsAll-CLR-Muc-ComBat-SeqRunSexSite-1-MsID/significant_results.tsv"),delim="\t")
...
readr::write_csv(df,here("Humanized-Biogeography-Analysis/differential_genera_site/HUM_Genus_Mucosal_taxonomy.csv"))
...
luminal<-readr::read_delim(here("Humanized-Biogeography-Analysis/differential_genera_site/HUM_L6-DCvsAll-CLR-Muc-ComBat-SeqRunSexSite-1-MsID/all_results.tsv"))
data <- luminal %>% filter(metadata=="Site" & qval<0.05)
...
annotation <- readr::read_csv(here("Humanized-Biogeography-Analysis/differential_genera_site/HUM_Genus_Mucosal_taxonomy.csv"))
