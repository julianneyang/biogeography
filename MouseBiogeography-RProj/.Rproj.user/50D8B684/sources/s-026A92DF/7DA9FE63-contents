...
library(plyr)
library(cowplot)
here::i_am("MouseBiogeography-RProj/CS_FacilityGMM-Type-Heatmap.R") #conflicts with plyr so use the :: notation
here::here()
...
duodenum<-readr::read_delim(here::here(
  path="CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Duodenum-ComBat-SeqRunSexType-1-MsID/significant_results.tsv")
...
jejunum<-readr::read_delim(here::here(
  path="CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Jejunum-ComBat-SeqRunSexType-1-MsID/significant_results.tsv")
  ,col_types = list(.default = readr::col_guess()))
...
ileum<-readr::read_delim(here::here(
  path="CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Ileum-ComBat-SeqRunSexType-1-MsID/significant_results.tsv")
  ,col_types = list(.default = readr::col_guess()))
...
cecum<-readr::read_delim(here::here(
  path="CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Cecum-ComBat-SeqRunSexType-1-MsID/significant_results.tsv")
  ,col_types = list(.default = readr::col_guess()))
...
pc<-readr::read_delim(here::here(
  path="CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-ProximalColon-ComBat-SeqRunSexType-1-MsID/significant_results.tsv"),
  col_types = list(.default = readr::col_guess()))
pc_significant<-filter(pc, metadata=="Type" & value=="Mucosal" &qval<0.05)
e<-pc_significant$feature  
DC<-readr::read_delim(here::here(
  path="CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-DistalColon-ComBat-SeqRunSexType-1-MsID/significant_results.tsv"),
  col_types = list(.default = readr::col_guess()))
...
duodenum<-read.table("CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Duodenum-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
...
jejunum<-read.table("CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Jejunum-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
...
ileum<-read.table("CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Ileum-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
ileum_all<-filter(ileum, metadata=="Type" & value=="Mucosal")
ileum_all<-ileum_all[match(target,ileum_all$feature),]
ileum_all$Site<- "Ileum"
cecum<-read.table("CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-Cecum-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
cecum_all<-filter(cecum, metadata=="Type" & value=="Mucosal")
cecum_all<-cecum_all[match(target,cecum_all$feature),]
cecum_all$Site<- "Cecum"
pc<-read.table("CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-ProximalColon-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
pc_all<-filter(pc, metadata=="Type" & value=="Mucosal")
pc_all<-pc_all[match(target,pc_all$feature),]
pc_all$Site<- "Proximal_Colon"
DC<-read.table("CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-LumRef-CLR-DistalColon-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
...
#write.csv(duojejilececpcdc, "CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-TYPE-Heatmap.csv") 
...
duojejilececpcdc<-read.csv("CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/GMM-TYPE-Heatmap.csv")
...
readr::write_rds(offtarget, "CS-Facility-Analysis/OMIXER-RPM Results/CS_GMM/omitted_GMM.RDS")
