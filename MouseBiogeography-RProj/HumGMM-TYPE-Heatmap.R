...
here::i_am("MouseBiogeography-RProj/HumGMM-TYPE-Heatmap.R") #conflicts with plyr so use the :: notation
here::here()
...
duodenum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Duodenum-ComBat-SexType-1-MsID/significant_results.tsv", header=TRUE)
duodenum_significant<-filter(duodenum, metadata=="Type" & value=="Mucosal" &qval<0.05)
a<-duodenum_significant$feature
jejunum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Jejunum-ComBat-SeqRunSexType-1-MsID/significant_results.tsv", header=TRUE)
jejunum_significant<-filter(jejunum, metadata=="Type" & value=="Mucosal" &qval<0.05)
b<-jejunum_significant$feature
ileum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Ileum-ComBat-SeqRunSexType-1-MsID/significant_results.tsv", header=TRUE)
ileum_significant<-filter(jejunum, metadata=="Type" & value=="Mucosal" &qval<0.05)
c<-ileum_significant$feature
cecum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Cecum-ComBat-SeqRunSexType-1-MsID/significant_results.tsv",header=TRUE)
cecum_significant<-filter(cecum, metadata=="Type" & value=="Mucosal" &qval<0.05)
d<-cecum_significant$feature  
pc<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-ProximalColon-ComBat-SeqRunSexType-1-MsID/significant_results.tsv",header=TRUE)
pc_significant<-filter(pc, metadata=="Type" & value=="Mucosal" &qval<0.05)
e<-pc_significant$feature  
DC<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-DistalColon-ComBat-SeqRunSexType-1-MsID/significant_results.tsv",header=TRUE)
...
duodenum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Duodenum-ComBat-SexType-1-MsID/all_results.tsv", header=TRUE)
...
jejunum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Jejunum-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
...
ileum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Ileum-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
ileum_all<-filter(ileum, metadata=="Type" & value=="Mucosal")
ileum_all<-ileum_all[match(target,ileum_all$feature),]
ileum_all$Site<- "Ileum"
cecum<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-Cecum-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
cecum_all<-filter(cecum, metadata=="Type" & value=="Mucosal")
cecum_all<-cecum_all[match(target,cecum_all$feature),]
cecum_all$Site<- "Cecum"
pc<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-ProximalColon-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
pc_all<-filter(pc, metadata=="Type" & value=="Mucosal")
pc_all<-pc_all[match(target,pc_all$feature),]
pc_all$Site<- "Proximal_Colon"
DC<-read.table("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-LumRef-CLR-DistalColon-ComBat-SeqRunSexType-1-MsID/all_results.tsv", header=TRUE)
...
#write.csv(duojejilececpcdc, "Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-TYPE-Heatmap.csv") 
...
duojejilececpcdc<-read.csv("Humanized-Biogeography-Analysis/Source RPCA/Hum/OMIXER-RPM/GMM-TYPE-Heatmap.csv")
