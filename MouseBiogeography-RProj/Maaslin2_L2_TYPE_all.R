...
## SPF Gavage --
input_data <- read.delim(here("Humanized-Biogeography-Analysis/starting_files/export_L2_min10000_Cedars_SPF_Colonized-ComBat-Adjusted-ASV/feature-table.tsv"), header=TRUE,row.names=1) 
df_input_data<-as.data.frame(input_data)
names(df_input_data)<-gsub("X","",names(df_input_data))
df_input_data <- df_input_data %>% select(-c(taxonomy))
...
# List of sites and corresponding file paths
site_paths <- list(
  Duodenum = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-Duodenum-ComBat-SeqRunSexType-1-MsID",
  Jejunum = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-Jejunum-ComBat-SeqRunSexType-1-MsID",
  Ileum = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-Ileum-ComBat-SeqRunSexType-1-MsID",
  Cecum = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-Cecum-ComBat-SeqRunSexType-1-MsID",
  Proximal_Colon = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-PC-ComBat-SeqRunSexType-1-MsID",
  Distal_Colon = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-DC-ComBat-SeqRunSexType-1-MsID"
)

site_general_paths <- list(
  SI = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-SI-ComBat-SeqRunSexSiteType-1-MsID",
  Colon = "Humanized-Biogeography-Analysis/differential_genera_type/L2-LumRef-CLR-Colon-ComBat-SeqRunSexSiteType-1-MsID"
)
...
## HUM Gavage --
input_data <- read.delim(here("Humanized-Biogeography-Analysis/starting_files/export_L2_min10000_Humanized_Colonized-ComBat-Adjusted-ASV/feature-table.tsv"), header=TRUE,row.names=1) 
df_input_data<-as.data.frame(input_data)
names(df_input_data)<-gsub("X","",names(df_input_data))
df_input_data <- df_input_data %>% select(-c(taxonomy))
input_metadata <-read.delim(here("Humanized-Biogeography-Analysis/starting_files/Humanized-Metadata.tsv"),header=TRUE, row.names=1) #mapping file
...
# List of sites and corresponding file paths
site_paths <- list(
  Jejunum = "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-Jejunum-ComBat-SeqRunSexType-1-MsID",
  Ileum = "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-Ileum-ComBat-SeqRunSexType-1-MsID",
  Cecum = "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-Cecum-ComBat-SeqRunSexType-1-MsID",
  Proximal_Colon = "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-PC-ComBat-SeqRunSexType-1-MsID",
  Distal_Colon = "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-DC-ComBat-SeqRunSexType-1-MsID"
)

site_general_paths <- list(
  SI = "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-SI-ComBat-SeqRunSexSiteType-1-MsID",
  Colon = "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-Colon-ComBat-SeqRunSexSiteType-1-MsID"
)
...
for (site in names(site_paths)) {
  ...
  # Run Maaslin2 analysis
  output_path <- "Humanized-Biogeography-Analysis/differential_genera_type/HUM_L2-LumRef-CLR-Duodenum-ComBat-SeqRunSexType-1-MsID"
...
site_paths <- list(
  ...
  Proximal_Colon = "Donors-Analysis/differential_genera_type/L2-LumRef-CLR-PC-ComBat-SeqRunSexType-1-MsID",
  Distal_Colon = "Donors-Analysis/differential_genera_type/L2-LumRef-CLR-DC-ComBat-SeqRunSexType-1-MsID"
)

site_general_paths <- list(
  SI = "Donors-Analysis/differential_genera_type/L2-LumRef-CLR-SI-ComBat-SeqRunSexSiteType-1-MsID",
  Colon = "Donors-Analysis/differential_genera_type/L2-LumRef-CLR-Colon-ComBat-SeqRunSexSiteType-1-MsID"
)
