...
names(data)
output=lme(fixed= shannon ~ Sequencing_Run + Sex + Site_General, random = ~1|MouseID_Original, data=data)
summary(output)
output=lme(fixed= observed_otus ~ Sequencing_Run + Sex + Site_General, random = ~1|MouseID_Original, data=data)
summary(output)
output=lme(fixed= chao1 ~ Sequencing_Run + Sex + Site_General, random = ~1|MouseID_Original, data=data)
summary(output)
output=lme(fixed= pielou_e ~ Sequencing_Run + Sex + Site_General, random = ~1|MouseID_Original, data=data)
summary(output)
