...
#UCLA V. SPF 
data<- read.csv("ImmDef-Mouse-Biogeography-Analysis/alpha_diversity_WTCohort.csv", header=TRUE, row.names=1)
...
alpha_diversity_muc <- plot_grid(ucla_o_otus_muc, ucla_v_otus_muc, cs_otus_muc, spf_gavage_otus_muc, hum_otus_muc, nrow=1)
#alpha_diversity_muc <- alpha_diversity_muc +labs(title="Mucosal") + theme(plot.title = element_text(hjust = 0.5)) 

alpha_diversity_pe_muc <- plot_grid(ucla_o_pe_muc, ucla_v_pe_muc, cs_pe_muc, spf_gavage_pe_muc, hum_pe_muc, nrow=1)
...
data<-read.csv("Regional-Mouse-Biogeography-Analysis/2021-8-Microbiome-Batch-Correction-Analysis/beta_diversity/RPCA for all Sites - Mucosal ordination.csv",
               header=FALSE)
...
data<-read.csv("Regional-Mouse-Biogeography-Analysis/2021-8-Microbiome-Batch-Correction-Analysis/beta_diversity/RPCA for all Sites - MucCol ordination.csv",
               header=FALSE)
...
data<-read.csv("Regional-Mouse-Biogeography-Analysis/2021-8-Microbiome-Batch-Correction-Analysis/beta_diversity/RPCA for all Sites - MucSI ordination.csv",
               header=FALSE)
...
# UCLA Validation SPF
metadata<- read.delim("ImmDef-Mouse-Biogeography-Analysis/RPCA/WTCohort-Metadata.tsv.txt", header=TRUE)

data<-read.csv("ImmDef-Mouse-Biogeography-Analysis/RPCA/Pre-Combat/WT Cohort Site RPCA - Mucosal.csv",
               header=FALSE)
...
data<-read.csv("ImmDef-Mouse-Biogeography-Analysis/RPCA/Pre-Combat/WT Cohort Site RPCA - Mucosal_Colon.csv",
               header=FALSE)
...
data<-read.csv("ImmDef-Mouse-Biogeography-Analysis/RPCA/Pre-Combat/WT Cohort Site RPCA - Mucosal_SI.csv",
               header=FALSE)
...
metadata <- read.csv("CS-Facility-Analysis/CS_Facility_Metadata.csv",
                     header=TRUE)
data<-read.csv("CS-Facility-Analysis/RPCA/Site_RPCA/CS_Facility_Site_RPCA - Mucosal.csv",
               header=FALSE)
...
data<-read.csv("CS-Facility-Analysis/RPCA/Site_RPCA/CS_Facility_Site_RPCA - Mucosal_Colon.csv",
               header=FALSE)
...
data<-read.csv("CS-Facility-Analysis/RPCA/Site_RPCA/CS_Facility_Site_RPCA - Mucosal_SI.csv",
               header=FALSE)
...
# Compile aggregated figure
interregional_muc <- plot_grid(ucla_o_pcoa_muc, ucla_v_pcoa_muc, cs_spf_muc, spf_pcoa_muc, hum_pcoa_muc, nrow=1)
#interregional_muc <- interregional_muc +labs(title="Mucosal") + theme(plot.title = element_text(hjust = 0.5)) 
interregional_mc <- plot_grid(ucla_o_pcoa_mc, ucla_v_pcoa_mc, cs_spf_mc, spf_pcoa_mc, hum_pcoa_mc, nrow=1)
#interregional_mc <- interregional_mc +labs(title="Mucosal") + theme(plot.title = element_text(hjust = 0.5)) 
interregional_msi <- plot_grid(ucla_o_pcoa_msi, ucla_v_pcoa_msi, cs_spf_msi, spf_pcoa_msi, hum_pcoa_msi, nrow=1)
