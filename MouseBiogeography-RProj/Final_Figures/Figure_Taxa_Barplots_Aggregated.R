...
cs_genera <- readRDS("CS-Facility-Analysis/Taxa-Barplots/assign_cols.RDS")
  cs_genera <- names(cs_genera)
ucla_v_genera <- readRDS("ImmDef-Mouse-Biogeography-Analysis/Taxa-Barplots/assign_cols.RDS")
  ucla_v_genera <- names(ucla_v_genera)
ucla_o_genera <- readRDS("Regional-Mouse-Biogeography-Analysis/2021-8-Microbiome-Batch-Correction-Analysis/Taxa-Barplots/assign_cols.RDS")
  ucla_o_genera <- names(ucla_o_genera)
spf_gavage <- readRDS("Humanized-Biogeography-Analysis/Source RPCA/SPF/barplots/assign_cols.RDS")
  spf_gavage <- names(spf_gavage)
hum_gavage <- readRDS("Humanized-Biogeography-Analysis/Source RPCA/Hum/barplots/assign_cols.RDS")
...
add_cols3 <- paletteer_d("dutchmasters::milkmaid",8)
...
readr::write_rds(global_genera_cols, "global_genera_cols.RDS")
...
UCLA_o_L6_muc <- Microbiome.Biogeography::generate_L6_taxa_plots("Regional-Mouse-Biogeography-Analysis/2021-8-Microbiome-Batch-Correction-Analysis/Taxa-Barplots/Mucosal_L6.RDS",
                                                                 "UCLA O. SPF", ".*g__",genera_cols, "Site") +
  theme(legend.position = "none")
UCLA_o_L6_muc

UCLA_o_L6_lum <- Microbiome.Biogeography::generate_L6_taxa_plots("Regional-Mouse-Biogeography-Analysis/2021-8-Microbiome-Batch-Correction-Analysis/Taxa-Barplots/Luminal_L6.RDS",
                                                                 "UCLA O. SPF", ".*g__",genera_cols, "Site") +
  theme(legend.position = "none")
UCLA_o_L6_lum
...
aggregated_L6_lum <- plot_grid(UCLA_o_L6_lum, cs_L6_lum, spf_gavage_L6_lum, hum_gavage_L6_lum,NULL, nrow=1, ncol=5)
dev.new(width=20, height=5)
aggregated_L6_lum

aggregated_L2_lum <- plot_grid(UCLA_o_L2_lum, cs_L2_lum, spf_gavage_L2_lum, hum_gavage_L2_lum,NULL, nrow=1, ncol=5)
dev.new(width=20, height=5)
aggregated_L2_lum
