...
file_path <- "Humanized-Biogeography-Analysis/taxa_barplots/HUM_Gavage_Luminal_level-6.csv"
...
file_path <- "Humanized-Biogeography-Analysis/taxa_barplots/HUM_Gavage_Mucosal_level-6.csv"
processed_data <- process_taxonomy_data(file_path)
...
assign_cols <- paletteer_d("ggsci::category20_d3", 19)
