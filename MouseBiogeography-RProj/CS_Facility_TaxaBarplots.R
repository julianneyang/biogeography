...
input_data <- read.csv("CS-Facility-Analysis/Taxa-Barplots/Luminal_level-6.csv", header=TRUE, row.names=1)
input_data <- read.csv("CS-Facility-Analysis/Taxa-Barplots/Mucosal_level-6.csv", header=TRUE, row.names=1)
input_data <- read.csv("CS-Facility-Analysis/Taxa-Barplots/Colon_level-6.csv", header=TRUE, row.names=1)
input_data <- read.csv("CS-Facility-Analysis/Taxa-Barplots/SI_level-6.csv", header=TRUE, row.names=1)
...
write_rds(input_data, "CS-Facility-Analysis/Taxa-Barplots/Luminal_level-6.RDS")
write_rds(input_data, "CS-Facility-Analysis/Taxa-Barplots/Mucosal_level-6.RDS")
write_rds(input_data, "CS-Facility-Analysis/Taxa-Barplots/Colon_level-6.RDS")
write_rds(input_data, "CS-Facility-Analysis/Taxa-Barplots/SI_level-6.RDS")
...
L2_lum<-readRDS("CS-Facility-Analysis/Taxa-Barplots/Luminal_level-6.RDS")
L2_lum<- as.matrix(L2_lum)
L2_lum<-make_relative(L2_lum)
L2_lum<-as.data.frame(t(L2_lum))
toptaxa<- rowMeans(L2_lum)
...
L2_lum<-readRDS("CS-Facility-Analysis/Taxa-Barplots/Mucosal_level-6.RDS")
L2_lum<- as.matrix(L2_lum)
L2_lum<-make_relative(L2_lum)
L2_lum<-as.data.frame(t(L2_lum))
toptaxa<- rowMeans(L2_lum)
