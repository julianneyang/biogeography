...
chao1<- read.table(here("Humanized-Biogeography-Analysis/alpha_min10000_Cedars_SPF_Colonized-ComBat-Adjusted-ASV/chao1_dir/alpha-diversity.tsv"), header=T,sep="\t")
otus<-read.table(here("Humanized-Biogeography-Analysis/alpha_min10000_Cedars_SPF_Colonized-ComBat-Adjusted-ASV/otus_dir/alpha-diversity.tsv"), header=T,sep="\t")
pielou<-read.table(here("Humanized-Biogeography-Analysis/alpha_min10000_Cedars_SPF_Colonized-ComBat-Adjusted-ASV/pielou_e_dir/alpha-diversity.tsv"), header=T,sep="\t")
shannon<-read.table(here("Humanized-Biogeography-Analysis/alpha_min10000_Cedars_SPF_Colonized-ComBat-Adjusted-ASV/shannon_dir/alpha-diversity.tsv"), header=T,sep="\t")
...
write.csv(data, "Humanized-Biogeography-Analysis/alpha_min10000_Cedars_SPF_Colonized-ComBat-Adjusted-ASV/spf_gavage_alpha_diversity_Humanized.csv")
...
data <- read.csv(here("Humanized-Biogeography-Analysis/alpha_min10000_Cedars_SPF_Colonized-ComBat-Adjusted-ASV/spf_gavage_alpha_diversity_Humanized.csv"),row.names=1)
...
## SPF Dataset Type --
sink(here("Humanized-Biogeography-Analysis/alpha_min10k_Humanized_ASV_for_alpha_diversity.qza/SPF_Type_Alpha_Diversity.txt"))
output=lme(fixed= observed_features ~ Sequencing_Run + Sex + Type, random = ~1|(MouseID), data=spf_duo)
summary(output)
output=lme(fixed= pielou_evenness~ Sequencing_Run + Sex + Type, random = ~1|(MouseID), data=spf_duo)
summary(output)
...
## HUM Dataset Type --
sink(here("Humanized-Biogeography-Analysis/alpha_min10k_Humanized_ASV_for_alpha_diversity.qza/HUM_Type_Alpha_Diversity.txt"))
