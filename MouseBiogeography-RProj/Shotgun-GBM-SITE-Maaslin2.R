...
here::i_am("MouseBiogeography-RProj/Shotgun-GBM-SITE-Maaslin2-Hum.R")
input_data <- readr::read_delim(here("Shotgun/omixer/Shotgun_GBM_modules.tsv"),delim="\t")
...
fit_data = Maaslin2(input_data=ucla_input_data, input_metadata=df_input_metadata, 
                    output = here("Shotgun/UCLA_O_SPF/GBM-DCvsJej-CLR-UCLA-ComBat-SeqRunLineSexSite-1-MsID"), 
...
fit_data = Maaslin2(input_data=cs_input_data, input_metadata=df_input_metadata, 
                    output = here("Shotgun/CS_SPF/GBM-DCvsJej-CLR-CS-ComBat-SeqRunSexSite-1-MsID"), 
...
fit_data = Maaslin2(input_data=hum_input_data, input_metadata=df_input_metadata, 
                    output = here("Shotgun/CS_SPF/GBM-DCvsJej-CLR-HUM-ComBat-SeqRunSexSite-1-MsID"), 
                    fixed_effects = c("Sequencing_Run","Sex", "Site"), 
                    random_effects = c("MouseID"),
                    reference= c('Site,Distal_Colon'),
                    normalization="clr", 
...
fit_data = Maaslin2(input_data=spf_input_data, input_metadata=df_input_metadata, 
                    output = here("Shotgun/CS_SPF/GBM-DCvsJej-CLR-SPF-ComBat-SeqRunSexSite-1-MsID"), 
                    fixed_effects = c("Sequencing_Run","Sex", "Site"), 
                    random_effects = c("MouseID"),
                    reference= c('Site,Distal_Colon'),
                    normalization="clr", 
