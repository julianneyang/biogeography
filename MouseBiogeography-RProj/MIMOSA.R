...
### Read in example config table to understand what's happening ---
config_table <- data.table(
  V1 = c("file1", "file2", "ref_choices", "file1Type", "data_prefix", "vsearch_path", "metType", "signifThreshold"),
  V2 = c("gg_OTUs.txt", "metabolites.txt", "AGORA genomes and models", "Greengenes 13_5 or 13_8 OTUs", 
         "~/Documents/MIMOSA2shiny/data/", "~/Documents/MIMOSA2shiny/bin/vsearch", "KEGG Compound IDs", "0.05")
)
simThreshold <- 0.05
