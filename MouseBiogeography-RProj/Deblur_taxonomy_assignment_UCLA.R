...
sequences <- readr::read_csv(here("Regional-Mouse-Biogeography-Analysis/UCLA_Original_taxonomy_assignments.csv"))
seqs<-sequences$ASV
set.seed(100)
...
readr::write_csv(output, here("Regional-Mouse-Biogeography-Analysis/UCLA_taxonomy_assignments_2.csv"))
